...
celln = '01';
recn = '0001';
file = ['PClamp_Data/', date, celln, '_', recn, '.abf'];
...
for i = 1:nsweeps
    ...
    saveas(gcf, ['PClamp_Data/', date, celln, '_', recn, '_sweep', num2str(i)], 'png')
    hold off
end
