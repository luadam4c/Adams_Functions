...
if plotErrorHistoryFlag
    ...
    % Plot error history
    plot_table_parallel(errorParamTable, errorsToPlot,...
...
if plotParamHistoryFlag
    ...
    plot_table_parallel(errorParamTable, errorParamToPlot,...
...
function handles = plot_table_parallel(historyTable, errorParamToPlot, ...
