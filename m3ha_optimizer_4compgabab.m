...
if outparams.fitPassiveFlag         % if fitting passive parameters
    ...
    [errCpr, outparams.hfig] = ...
        m3ha_neuron_run_and_analyze(outparams.neuronParamsTable, ...
            ...
            'Prefix', outparams.prefix, 'OutFolder', outparams.outFolder, ...
...
if outparams.simMode == 1
    figname = fullfile(outparams.outFolder, [outparams.prefix, '_cpr_overlapped_traces.png']);
else
end
if outparams.simMode == 1
    figname = fullfile(outparams.outFolder, [outparams.prefix, '_cpr_GABABi_comparison.png']);
else
end
if outparams.simMode == 1
    figname = fullfile(outparams.outFolder, [outparams.prefix, '_cpr_GABABg_comparison.png']);
else
end
if outparams.simMode == 1
    figname = fullfile(outparams.outFolder, [outparams.prefix, '_cpr_alltraces_zoom.png']);
else
end
