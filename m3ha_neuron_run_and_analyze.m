...
elseif strcmpi(simMode, 'active')
    [tVecs, vVecsSim, gVecsSim, iVecsSim, ...
            icaVecsSim, itmVecsSim, ithVecsSim, ...
        ...
        extract_columns(simData, [TIME_COL_SIM, VOLT_COL_SIM, ...
                        ...
                        ICA_COL_SIM, ITM_COL_SIM, ITH_COL_SIM, ...
...
if bootstrapCprFlag && ~isempty(realData) && strcmpi(simMode, 'passive')
    ...
    elseif strcmpi(simMode, 'active')
        [tVecs, vVecsSim, iVecsSim, itmVecsSim, ithVecsSim, ...
            ...
            extract_columns(simData, [TIME_COL_SIM, VOLT_COL_SIM, ...
                            IEXT_COL_SIM, ITM_COL_SIM, ITH_COL_SIM, ...
...
if plotFlag
    ...
    if plotOverlappedFlag
        ...
        elseif strcmpi(simMode, 'active')
            dataForOverlapped = {vVecsSim; gVecsSim; iVecsSim; icaVecsSim; ...
                    itmVecsSim; ithVecsSim; ihVecsSim; ihmVecsSim; ...
        ...
        elseif strcmpi(simMode, 'active')
            yLabelsOverlapped = {'V_{soma} (mV)'; 'g_{GABA_B} (uS)'; ...
                    'I_{stim} (nA)'; 'I_{Ca} (mA/cm^2)'; 'm_{T}'; 'h_{T}'; ...
...
% Decide on the column numbers to extract
colsToExtractSim = [TIME_COL_SIM, VOLT_COL_SIM, IEXT_COL_SIM];
...
[tVecs, vVecsSim, iVecsSim] = ...
    extract_columns(simData, [TIME_COL_SIM, VOLT_COL_SIM, IEXT_COL_SIM]);
...
% IEXT_COL_SIM = iCP_COL_SIM;
% IEXT_COL_SIM = IDCLAMP_COL_SIM;
