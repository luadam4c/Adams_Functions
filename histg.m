...
%             nbins - number of bins (none by default)
%             edges - edges of the bins (none by default)
%             group_names - labels for each group, must be a cell array in column form (none by default)
