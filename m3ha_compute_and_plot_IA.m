function [v, m1inf, m2inf, hinf, taum, tauh1, tauh2, IMax, IInit, IInf] = m3ha_compute_and_plot_IA(varargin)
%% Plot activation/inactivation curves for the T-type calcium current
% Usage: [v, m1inf, m2inf, hinf, taum, tauh1, tauh2, IMax, IInit, IInf] = m3ha_compute_and_plot_IA(varargin)
%
% Arguments:    
...
iP = inputParser;         
iP.FunctionName = 'm3ha_compute_and_plot_IA';
...
if plotInfFlag
    ...
    set(gca, 'FontSize', 15);
    saveas(hfig1, fullfile(outFolder, ['IA_m1inf_m2inf_hinf', suffix]), 'png');
end
...
if plotTauFlag
    ...
    legend('location', 'northeast');
    set(gca, 'FontSize', 15);
    saveas(hfig2, fullfile(outFolder, ['IA_taum_tauh1_tauh2', suffix]), 'png');
end
...
if plotIVFlag
    ...
    title(['I-V relationship of IA for ', strrep(suffix(2:end), '_', '\_')]);
    legend('location', 'northwest');
    set(gca, 'FontSize', 15);
    saveas(hfig3, fullfile(outFolder, ['IA_I-V', suffix]), 'png');
end
