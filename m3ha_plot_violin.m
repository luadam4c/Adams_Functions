...
diffTable = struct2table(diffStruct, 'AsArray', true);
diffTable = addvars(diffTable, allMeasureTitles, 'Before', 1, ...
                    'VariableNames', 'measureTitle');
