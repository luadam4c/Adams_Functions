...
Last Updated 2020-09-09 by Adam Lu
...
- [**all_data_files.m**](https://github.com/blabuva/Adams_Functions/blob/master/all_data_files.m): Looks for data files in a directory according to either extensionUser or going through a list of possibleExtensions
- [**all_dependent_files.m**](https://github.com/blabuva/Adams_Functions/blob/master/all_dependent_files.m): Prints all dependent files used by a given MATLAB script/function
...
- [**combine_swd_resp_data.m**](https://github.com/blabuva/Adams_Functions/blob/master/combine_swd_resp_data.m): Parses and concatenates SWD and resp files from different source data .atf and .mat files
...
- [**compile_script.m**](https://github.com/blabuva/Adams_Functions/blob/master/compile_script.m): Compiles a MATLAB script/function
...
- [**compute_rms_Gaussian.m**](https://github.com/blabuva/Adams_Functions/blob/master/compute_rms_Gaussian.m): Compute the root-mean-square level of the "Gaussian part" of a data vector
...
- [**compute_time_average.m**](https://github.com/blabuva/Adams_Functions/blob/master/compute_time_average.m): Computes the time average of a value vector over time window(s)
...
- [**count_events.m**](https://github.com/blabuva/Adams_Functions/blob/master/count_events.m): Counts events before and after stimulation
...
- [**create_shifted_vectors.m**](https://github.com/blabuva/Adams_Functions/blob/master/create_shifted_vectors.m): Creates shifted vectors based on values to shift
...
- [**find_directional_events.m**](https://github.com/blabuva/Adams_Functions/blob/master/find_directional_events.m): Find all directional events in a data vector
...
- [**identify_bursts.m**](https://github.com/blabuva/Adams_Functions/blob/master/identify_bursts.m): Identify bursts from a list of directional events
...
- [**minEASE_combine_events.m**](https://github.com/blabuva/Adams_Functions/blob/master/minEASE_combine_events.m): Convert info from Excel file into a structure for GUI
- [**minEASE_compute_plot_average_psc.m**](https://github.com/blabuva/Adams_Functions/blob/master/minEASE_compute_plot_average_psc.m): Computes and plots averaged Type I, II & III PSC traces
- [**minEASE_detect_gapfree_events.m**](https://github.com/blabuva/Adams_Functions/blob/master/minEASE_detect_gapfree_events.m): Spontaneous EPSC/IPSC detector and classifyer
- [**minEASE_examine_gapfree_events.m**](https://github.com/blabuva/Adams_Functions/blob/master/minEASE_examine_gapfree_events.m): Examine detected events and allow additions and deletions
- [**minEASE_extract_from_output_filename.m**](https://github.com/blabuva/Adams_Functions/blob/master/minEASE_extract_from_output_filename.m): Extracts information from a minEASE output filename
- [**minEASE_filter_events.m**](https://github.com/blabuva/Adams_Functions/blob/master/minEASE_filter_events.m): Filter events and compute inter-event intervals based on criteria
- [**minEASE_filter_output.m**](https://github.com/blabuva/Adams_Functions/blob/master/minEASE_filter_output.m): Filter the combined output from a minEASE output directory
- [**minEASE_gui_examine_events.m**](https://github.com/blabuva/Adams_Functions/blob/master/minEASE_gui_examine_events.m): A graphic user interface for examining detected events
- [**minEASE_load_output.m**](https://github.com/blabuva/Adams_Functions/blob/master/minEASE_load_output.m): Load the output and relevant parameters from a minEASE output directory into an output structure
- [**minEASE.m**](https://github.com/blabuva/Adams_Functions/blob/master/minEASE.m): Detect synaptic events
- [**minEASE_plot_gapfree_events.m**](https://github.com/blabuva/Adams_Functions/blob/master/minEASE_plot_gapfree_events.m): Plots all detected events 
- [**minEASE_read_params.m**](https://github.com/blabuva/Adams_Functions/blob/master/minEASE_read_params.m): Convert info from Excel file into a structure for GUI
