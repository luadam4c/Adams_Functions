...
- [**plot_history_table.m**](https://github.com/blabuva/Adams_Functions/blob/master/plot_history_table.m): Plots the history of variables given a table where each row is an iteration
