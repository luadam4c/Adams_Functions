...
- [**compute_autocorrelogram.m**](https://github.com/blabuva/Adams_Functions/blob/master/compute_autocorrelogram.m): TODO: A summary of what the function does (must be a single unbreaked line)
