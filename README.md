...
- [**concatenate_swd_files.m**](https://github.com/blabuva/Adams_Functions/blob/master/concatenate_swd_files.m): Parses and concatenates SWD and pleth files from different source data .atf and .mat files
