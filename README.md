...
- [**parse_current_injection_protocol.m**](https://github.com/blabuva/Adams_Functions/blob/master/parse_current_injection_protocol.m): From a current injection protocol, detect spikes for each sweep and make an F-I plot
