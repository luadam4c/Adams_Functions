...
- [**read_data_atf.m**](https://github.com/blabuva/Adams_Functions/blob/master/read_data_atf.m): Writes a data matrix to an Axon Text File formatted text file (.atf)
