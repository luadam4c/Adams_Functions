...
Last Updated 2019-01-11 by Adam Lu
...
- [**find_index_in_array.m**](https://github.com/blabuva/Adams_Functions/blob/master/find_index_in_array.m): Returns the first matching index in an array for candidate(s)
