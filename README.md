...
- [**create_default_grouping.m**](https://github.com/blabuva/Adams_Functions/blob/master/create_default_grouping.m): Creates default grouping vectors and grouping labels from data
...
- [**find_index_in_list.m**](https://github.com/blabuva/Adams_Functions/blob/master/find_index_in_list.m): Returns the first matching index in an array for candidate(s)
...
- [**parse_lts.m**](https://github.com/blabuva/Adams_Functions/blob/master/parse_lts.m): Find, plot and classify the most likely low-threshold spike (LTS) candidate in a voltage trace
...
- [**plot_histogram_with_outliers.m**](https://github.com/blabuva/Adams_Functions/blob/master/plot_histogram_with_outliers.m): Plots a histogram labelling out of range values differently
