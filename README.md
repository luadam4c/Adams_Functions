...
Last Updated 2018-10-27 by Adam Lu
...
- [**match_vector_counts.m**](https://github.com/blabuva/Adams_Functions/blob/master/match_vector_counts.m): Matches a set of vectors to another set of vectors so that they have equal number of vectors
