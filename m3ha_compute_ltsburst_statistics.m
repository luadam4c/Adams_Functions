...
%       statsTable = m3ha_compute_ltsburst_statistics('PharmConditions', num2cell(1:4))
...
if manyConditionsFlag
    ...
    [allValues, nValues, meanValue, stdValue, ...
        ...
        cellfun(@(x, y, z) ...
                ...
                burstDelayStr, spikesPerBurstStr, measureStr), ...
...
[pharmCondition, gIncrCondition, vHoldCondition] = ...
    argfun(@force_column_cell, pharmCondition, gIncrCondition, vHoldCondition);
