function [indDecision, slopeValues, concavityValues] = ...
                m3ha_find_decision_point (itm2hDiff, varargin)
%% Finds the indices for the decision points in the 
% Usage: [indDecision, slopeValues, concavityValues] = ...
...
[indDecisionRise, slopeValues, concavityValues] = ...
...
concavityValues = extract_elements(d2xdt2Vecs, 'specific', ...
                                    'Index', ind2Decision);
