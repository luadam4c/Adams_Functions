...
switch plotType
    ...
    case 'm2h'
        handles = m3ha_plot_m2h(simData, buildMode, ...
                                    xLimits, colorMap, lineWidth, ...
                                    expStr, expStrForTitle, otherArguments);
    case {'voltageVsOpd1', 'voltageVsOpd2'}
...
figTitle6 = sprintf('Concavity vs. Slope of Discrepancy');
plotPrePostForOtherVecs = false;
...
if strcmpi(plotType, 'voltageVsOpd1')
    [tVecsLts, vVecsLts, itmLts, itminfLts, ...
        ...
        argfun(@(x) extract_subvectors(x, 'Endpoints', endPointsPeak), ...
                ...
                ithVecsSim, ithinfVecsSim, itm2hDiff, otherXVecs, otherYVecs);
...
% Restrict to pre- and post-LTS regions
if strcmpi(plotType, 'voltageVsOpd1')
...
if strcmpi(plotType, 'voltageVsOpd1')
    ...
    % Find inflection points
    indInflection = find_inflection_points_voltage_vs_opd(tVecsLts, vVecsLts, ...
...
handles.traces2 = ...
    plot_traces(tVecsLts, itmLts, 'XLimits', timeLimits, ...
                'Marker', '.', 'LineStyle', 'none', 'LineWidth', lineWidth, ...
                'Verbose', false, 'PlotMode', 'overlapped', ...
                'PlotOnly', true, 'ColorMap', colorMap);
handles.tracesToCompare2 = ...
    plot_traces(tVecsLts, itminfLts, 'XLimits', timeLimits, ...
                'Marker', '.', 'LineStyle', 'none', 'LineWidth', lineWidth, ...
                'Verbose', false, 'PlotMode', 'overlapped', ...
...
handles.traces3 = ...
    plot_traces(tVecsLts, ithLts, 'XLimits', timeLimits, ...
                'Marker', '.', 'LineStyle', 'none', 'LineWidth', lineWidth, ...
                'Verbose', false, 'PlotMode', 'overlapped', ...
                'PlotOnly', true, 'ColorMap', colorMap);
handles.tracesToCompare3 = ...
    plot_traces(tVecsLts, ithinfLts, 'XLimits', timeLimits, ...
                'Marker', '.', 'LineStyle', 'none', 'LineWidth', lineWidth, ...
                'Verbose', false, 'PlotMode', 'overlapped', ...
                'LegendLocation', 'suppress', 'ColorMap', colorMapToCompare, ...
