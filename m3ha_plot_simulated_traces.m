...
elseif strcmpi(buildMode, 'active')
    dataForOverlapped = {vVecsSim; vVecsDend1; ...
            vVecsDend2; gVecsSim; iVecsSim; ...
            itTotal; ihTotal; iaTotal; ikirTotal; inapTotal; ...
...
elseif strcmpi(buildMode, 'active')
    yLabelsOverlapped = {'V_{soma} (mV)'; 'V_{dend1} (mV)'; ...
            'V_{dend2} (mV)'; 'g_{GABA_B} (uS)'; 'I_{stim} (nA)'; ...
            'I_{Ca} (mA/cm^2)'; 'I_{h} (mA/cm^2)'; 'I_{A} (mA/cm^2)'; ...
            'I_{Kir} (mA/cm^2)'; 'I_{NaP} (mA/cm^2)'; ...
            'I_{Ca,soma} (mA/cm^2)'; 'I_{Ca,dend1} (mA/cm^2)'; ...
            'I_{Ca,dend2} (mA/cm^2)'; ...
