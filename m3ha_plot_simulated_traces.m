...
padRemaining = set_default_flag([], false);
...
if plotSelected
    % Find inflection points from the LTS rising phase
    %   Note: these indices correspond to the LTS region as well
    indInflection = ...
        find_inflection_points_voltage_vs_opd(tVecsRise, vVecsRise, ...
...
if ~plotPhasePlotsOnly
    ...
    if plotSelected
        handles.selected1 = ...
            plot_selected(tVecsRise, vVecsRise, indInflection, ...
...
if ~plotPhasePlotsOnly
    ...
    if plotSelected
        handles.selected2 = ...
            plot_selected(tVecsRise, itmRise, indInflection, ...
                        'ColorMap', colorMap, 'LineWidth', lineWidth, ...
                        'Marker', 'o', 'MarkerSize', selectedMarkerSize);
        handles.selected2 = ...
            plot_selected(tVecsRise, itminfRise, indInflection, ...
                        'ColorMap', colorMap, 'LineWidth', lineWidth, ...
                        'Marker', 'o', 'MarkerSize', selectedMarkerSize);
    end
...
if ~plotPhasePlotsOnly
    ...
    if plotSelected
        handles.selected3 = ...
            plot_selected(tVecsRise, ithRise, indInflection, ...
                        'ColorMap', colorMap, 'LineWidth', lineWidth, ...
                        'Marker', 'o', 'MarkerSize', selectedMarkerSize);
        handles.selected3 = ...
            plot_selected(tVecsRise, ithinfRise, indInflection, ...
                        'ColorMap', colorMap, 'LineWidth', lineWidth, ...
                        'Marker', 'o', 'MarkerSize', selectedMarkerSize);
    end
...
if ~plotPhasePlotsOnly
    ...
    if plotSelected
        handles.selected4 = ...
            plot_selected(tVecsRise, itm2hDiffRise, indInflection, ...
                        'ColorMap', colorMap, 'LineWidth', lineWidth, ...
                        'Marker', 'o', 'MarkerSize', selectedMarkerSize);
    end
end
...
if ~plotPhasePlotsOnly
    ...
    if plotSelected
        handles.selected5 = ...
            plot_selected(itm2hDiffRise, vVecsRise, indInflection, ...
                        'ColorMap', colorMap, 'LineWidth', lineWidth, ...
                        'Marker', 'o', 'MarkerSize', selectedMarkerSize);
    end
end
