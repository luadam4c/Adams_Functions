...
figureRebuttal1Dir = ...
    fullfile(parentDirectory, 'manuscript', 'figures', 'FigureRebuttal1');
figureRebuttal2Dir = ...
...
popDataPath2CellBicRT = fullfile(figureRebuttal1Dir, popDataSheetName2CellBicRT);
popDataPath200Cell = fullfile(figure09Dir, popDataSheetName200Cell);
popDataPath200CellBicRT = fullfile(figureRebuttal2Dir, popDataSheetName200CellBicRT);
popDataPathHetero = fullfile(figure09Dir, popDataSheetNameHetero);
popDataPathHeteroBicRT = fullfile(figureRebuttal2Dir, popDataSheetNameHeteroBicRT);
...
if plotIpscComparisonBicRT
    cellfun(@(x, y) plot_ipsc_comparison(x, exampleIterName2CellBicRT, ...
                                        gIncr, y, figureRebuttal1Dir, figTypes, ...
                                        ipscFigWidth, ipscFigHeight, ...
                                        xLimits2CellGabab, yLimitsGabab), ...
...
if plot2CellEssentialBicRT
    cellfun(@(a, b) ...
        cellfun(@(x, y) plot_2cell_examples(x, exampleIterName2CellBicRT, ...
                        gIncr, a, y, figureRebuttal1Dir, figTypes, ...
...
if plot200CellExamplesBicRT
    arrayfun(@(z) ...
        cellfun(@(x, y) plot_200cell_examples(x, exampleIterName200CellBicRT, ...
                            gIncr, z, y, figureRebuttal2Dir, figTypes, ...
                        example200CellFigWidth, example200CellFigHeight), ...
...
if plot2CellViolinsBicRT
    ...
    stats2dPath2CellBicRT = ...
        fullfile(figureRebuttal1Dir, strcat(conditionLabel2CellBicRT, '_stats.mat'));
...
if plot200CellViolinsBicRT
    ...
    stats2dPath200CellBicRT = ...
        fullfile(figureRebuttal2Dir, strcat(conditionLabel200CellBicRT, '_stats.mat'));
...
if plotHeteroViolinsBicRT
    ...
    stats2dPathHeteroBicRT = ...
        fullfile(figureRebuttal2Dir, strcat(conditionLabelHeteroBicRT, '_stats.mat'));
...
if archiveScriptsFlag
    if plotIpscComparison || plot2CellEssential || plot2CellM2h || ...
        ...
        archive_dependent_scripts(mfilename, 'OutFolder', figureRebuttal1Dir);
    end
