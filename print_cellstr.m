...
addParameter(iP, 'Delimiter', delimiterDefault, @ischar);
addParameter(iP, 'RowDelimiter', rowDelimiterDefault, @ischar);
addParameter(iP, 'ColDelimiter', colDelimiterDefault, @ischar);
addParameter(iP, 'Prefix', prefixDefault, @ischar);
addParameter(iP, 'Suffix', suffixDefault, @ischar);
