...
if plotBarFlag
    ...
    h = figure(1005);
    clf(h);
    h = plot_bar(h, muLogModel2, muLogModel2Low, muLogModel2High, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
    ...
    h = figure(1006);
    clf(h);
    h = plot_bar(h, muLogModel3, muLogModel3Low, muLogModel3High, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'XTickLabel', {'Intra-burst', 'Inter-burst'});
    legend(allGroups, 'Interpreter', 'none', 'location', 'northwest');
    ...
    h = figure(1007);
    clf(h);
    h = plot_bar(h, [muLogModel2(1, :); muLogModel3(1, :)], ...
...
if plotBarFlag
    h = figure(1007);
    clf(h);
    h = plot_bar(h, muPerSliceLogModel2, muPerSliceLogModel2Low, ...
    ...
    h = figure(1008);
    clf(h);
    h = plot_bar(h, muPerSliceLogModel3, muPerSliceLogModel3Low, ...
    ...
    h = figure(1009);
    clf(h);
    h = plot_bar(h, [muPerSliceLogModel2(1, :); muPerSliceLogModel3(1, :)], ...
    ...
    h = figure(1010);
    clf(h);
    h = plot_bar(h, spacingPerSlice, spacingPerSliceLow, spacingPerSliceHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'XTickLabel', {'Gauss-Gauss', 'Gauss-ExpExp'});
    legend(allGroups, 'Interpreter', 'none', 'location', 'eastoutside');
    ...
    h = figure(1011);
    clf(h);
    h = plot_bar(h, threshold1PerSlice, threshold1PerSliceLow, threshold1PerSliceHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'XTickLabel', {'Gauss-Gauss', 'Gauss-ExpExp'});
    legend(allGroups, 'Interpreter', 'none', 'location', 'eastoutside');
    ...
    h = figure(1012);
    clf(h);
    h = plot_bar(h, threshold2PerSlice, threshold2PerSliceLow, threshold2PerSliceHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'XTickLabel', {'Gauss-Gauss', 'Gauss-ExpExp'});
    legend(allGroups, 'Interpreter', 'none', 'location', 'eastoutside');
    ...
    h = figure(1013);
    clf(h);
    h = plot_bar(h, void1PerSlice, void1PerSliceLow, void1PerSliceHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'XTickLabel', {'Gauss-Gauss', 'Gauss-ExpExp'});
    legend(allGroups, 'Interpreter', 'none', 'location', 'eastoutside');
    ...
    h = figure(1014);
    clf(h);
    h = plot_bar(h, void2PerSlice, void2PerSliceLow, void2PerSliceHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'XTickLabel', {'Gauss-Gauss', 'Gauss-ExpExp'});
    legend(allGroups, 'Interpreter', 'none', 'location', 'eastoutside');
...
if plotBarFlag
    h = figure(1017);
    clf(h);
    h = plot_bar(h, muPerCellLogModel0, muPerCellLogModel0Low, ...
    ...
    h = figure(1018);
    clf(h);
    h = plot_bar(h, muPerCellLogModel2, muPerCellLogModel2Low, ...
    ...
    h = figure(1019);
    clf(h);
    h = plot_bar(h, muPerCellLogModel3, muPerCellLogModel3Low, ...
    ...
    h = figure(1020);
    clf(h);
    h = plot_bar(h, [muPerCellLogModel0(1, :); muPerCellLogModel2(1, :); ...
    ...
    h = figure(1021);
    clf(h);
    h = plot_bar(h, spacingPerCell, spacingPerCellLow, spacingPerCellHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'XTickLabel', {'Kernel', 'Gauss-Gauss', 'Gauss-ExpExp'});
    legend(allGroups, 'Interpreter', 'none', 'location', 'eastoutside');
    ...
    h = figure(1022);
    clf(h);
    h = plot_bar(h, threshold1PerCell, threshold1PerCellLow, threshold1PerCellHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'XTickLabel', {'Kernel', 'Gauss-Gauss', 'Gauss-ExpExp'});
    legend(allGroups, 'Interpreter', 'none', 'location', 'eastoutside');
    ...
    h = figure(1023);
    clf(h);
    h = plot_bar(h, threshold2PerCell, threshold2PerCellLow, threshold2PerCellHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'XTickLabel', {'Kernel', 'Gauss-Gauss', 'Gauss-ExpExp'});
    legend(allGroups, 'Interpreter', 'none', 'location', 'eastoutside');
    ...
    h = figure(1024);
    clf(h);
    h = plot_bar(h, void1PerCell, void1PerCellLow, void1PerCellHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'XTickLabel', {'Kernel', 'Gauss-Gauss', 'Gauss-ExpExp'});
    legend(allGroups, 'Interpreter', 'none', 'location', 'eastoutside');
    ...
    h = figure(1025);
    clf(h);
    h = plot_bar(h, void2PerCell, void2PerCellLow, void2PerCellHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'XTickLabel', {'Kernel', 'Gauss-Gauss', 'Gauss-ExpExp'});
    legend(allGroups, 'Interpreter', 'none', 'location', 'eastoutside');
