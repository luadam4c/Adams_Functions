...
if plotBarFlag
    ...
    h = figure(1005);
    clf(h);
    plot_bar(muLogModel2, muLogModel2Low, muLogModel2High, ...
                    'BarSeparation', 0.135, 'CILineWidth', 2, ...
                    'PTickLabel', {'Intra-burst', 'Inter-burst'}, ...
                    'ForceVectorAsRow', true, 'FigHandle', h);
    legend(allGroups, 'Interpreter', 'none', 'location', 'northwest');
    ylabel('Mean inter-event interval (s)');
    ...
    h = figure(1006);
    clf(h);
    plot_bar(muLogModel3, muLogModel3Low, muLogModel3High, ...
                    'BarSeparation', 0.135, 'CILineWidth', 2, ...
                    'PTickLabel', {'Intra-burst', 'Inter-burst'}, ...
                    'ForceVectorAsRow', true, 'FigHandle', h);
    legend(allGroups, 'Interpreter', 'none', 'location', 'northwest');
    ...
    h = figure(1007);
    clf(h);
    plot_bar([muLogModel2(1, :); muLogModel3(1, :)], ...
                    [muLogModel2Low(1, :); muLogModel3Low(1, :)], ...
                    [muLogModel2High(1, :); muLogModel3High(1, :)], ...
                    'BarSeparation', 0.135, 'CILineWidth', 2, ...
                    'PTickLabel', {'Gauss-Gauss', 'Gauss-ExpExp'}, ...
                    'ForceVectorAsRow', true, 'FigHandle', h);
...
if plotBarFlag
    h = figure(1007);
    clf(h);
    plot_bar(muPerSliceLogModel2, muPerSliceLogModel2Low, ...
    ...
    h = figure(1008);
    clf(h);
    plot_bar(muPerSliceLogModel3, muPerSliceLogModel3Low, ...
    ...
    h = figure(1009);
    clf(h);
    plot_bar([muPerSliceLogModel2(1, :); muPerSliceLogModel3(1, :)], ...
    ...
    h = figure(1010);
    clf(h);
    plot_bar(spacingPerSlice, spacingPerSliceLow, spacingPerSliceHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'PTickLabel', {'Gauss-Gauss', 'Gauss-ExpExp'}, ...
                    'ForceVectorAsRow', true, 'FigHandle', h);
    ...
    h = figure(1011);
    clf(h);
    plot_bar(threshold1PerSlice, threshold1PerSliceLow, threshold1PerSliceHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'PTickLabel', {'Gauss-Gauss', 'Gauss-ExpExp'}, ...
                    'ForceVectorAsRow', true, 'FigHandle', h);
    ...
    h = figure(1012);
    clf(h);
    plot_bar(threshold2PerSlice, threshold2PerSliceLow, threshold2PerSliceHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'PTickLabel', {'Gauss-Gauss', 'Gauss-ExpExp'}, ...
                    'ForceVectorAsRow', true, 'FigHandle', h);
    ...
    h = figure(1013);
    clf(h);
    plot_bar(void1PerSlice, void1PerSliceLow, void1PerSliceHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'PTickLabel', {'Gauss-Gauss', 'Gauss-ExpExp'}, ...
                    'ForceVectorAsRow', true, 'FigHandle', h);
    ...
    h = figure(1014);
    clf(h);
    plot_bar(void2PerSlice, void2PerSliceLow, void2PerSliceHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'PTickLabel', {'Gauss-Gauss', 'Gauss-ExpExp'}, ...
                    'ForceVectorAsRow', true, 'FigHandle', h);
...
for iGroup = 1:nGroups            % for each experimental group
    ...
    if plotStatHistFlag
        ...
        plot_grouped_histogram(exp(mu1LogModel0AllCells  ...
                'FigName', figname, 'GroupingLabels',  sliceNumLogModel0, allSliceLabels, ...
                    'XLabel', 'Intra-burst means (s)', ...
                    'FigTitle', ['Intra-burst means of ', idGroup, ...
                    ' using kernel distribution fits'], ...
                    'YLabel', 'Cell count');
        figname = fullfile(figsFolder, ['mu1_', idGroup, '_GaussOnly']);
        plot_grouped_histogram(exp(mu1LogModel2AllCells  ...
                'FigName', figname, 'GroupingLabels',  sliceNumLogModel2, allSliceLabels, ...
                    'XLabel', 'Intra-burst means (s)', ...
                    'FigTitle', ['Intra-burst means of ', idGroup, ...
                    ' using Two-Gaussian fits'], ...
                    'YLabel', 'Cell count');
        figname = fullfile(figsFolder, ['mu1_', idGroup, '_GaussExp']);
        plot_grouped_histogram(exp(mu1LogModel3AllCells  ...
                'FigName', figname, 'GroupingLabels',  sliceNumLogModel3, allSliceLabels, ...
                    'XLabel', 'Intra-burst means (s)', ...
                    'FigTitle', ['Intra-burst means of ', idGroup, ...
                    ' using Gaussian-ExpExponential fits'], ...
                    'YLabel', 'Cell count');
        figname = fullfile(figsFolder, ['mu2_', idGroup, '_Kernel']);
        plot_grouped_histogram(exp(mu2LogModel0AllCells  ...
                'FigName', figname, 'GroupingLabels',  sliceNumLogModel0, allSliceLabels, ...
                    'XLabel', 'Inter-burst means (s)', ...
                    'FigTitle', ['Inter-burst means of ', idGroup, ...
                    ' using kernel distribution fits'], ...
                    'YLabel', 'Cell count');
        figname = fullfile(figsFolder, ['mu2_', idGroup, '_GaussOnly']);
        plot_grouped_histogram(exp(mu2LogModel2AllCells  ...
                'FigName', figname, 'GroupingLabels',  sliceNumLogModel2, allSliceLabels, ...
                    'XLabel', 'Inter-burst means (s)', ...
                    'FigTitle', ['Inter-burst means of ', idGroup, ...
                    ' using Two-Gaussian fits'], ...
        ...
        plot_grouped_histogram(mu2LogModel3AllCells, ..iceNumLogModel3, ...
                    'FigName', figname, 'GroupingLabels', allSliceLabels, ...
                    'XLabel', 'Inter-burst means (s)', ...
                    'FigTitle', ['Inter-burst means of ', idGroup, ...
                    ' using Gaussian-ExpExponential fits'], ...
                    'YLabel', 'Cell count');
        figname = fullfile(figsFolder, ['spacing_', idGroup, '_Kernel']);
        plot_grouped_histogram(spacingLogModel0AllCells  ...
                    'FigName', figname, 'GroupingLabels', sliceNumLogModel0, allSliceLabels, ...
                    'XLabel', 'Spacing parameters (log s)', ...
                    'FigTitle', ['Spacing parameters of ', idGroup, ...
                    ' using kernel distribution fits'], ...
                    'YLabel', 'Cell count');
        figname = fullfile(figsFolder, ['spacing_', idGroup, '_GaussOnly']);
        plot_grouped_histogram(spacingLogModel2AllCells  ...
                    'FigName', figname, 'GroupingLabels', sliceNumLogModel2, allSliceLabels, ...
                    'XLabel', 'Spacing parameters (log s)', ...
                    'FigTitle', ['Spacing parameters of ', idGroup, ...
                    ' using Two-Gaussian fits'], ...
        ...
        plot_grouped_histogram(spacingLogModel3AllCells  ...
                    'FigName', figname, 'GroupingLabels', sliceNumLogModel3, allSliceLabels, ...
                    'XLabel', 'Spacing parameters (log s)', ...
                    'FigTitle', ['Spacing parameters of ', idGroup, ...
                    ' using Gaussian-ExpExponential fits'], ...
        ...
        plot_grouped_histogram(exp(threshold1LogModel0A  ...
                'FigName', figname, 'GroupingLabels',         sliceNumLogModel0, allSliceLabels, ...
                    'XLabel', 'Thresholds (s)', ...
                    'FigTitle', ['Thresholds of ', idGroup, ...
                    ' using kernel distribution fits'], ...
                    'YLabel', 'Cell count');
        figname = fullfile(figsFolder, ['threshold1_', idGroup, '_GaussOnly']);
        plot_grouped_histogram(exp(threshold1LogModel2A  ...
                'FigName', figname, 'GroupingLabels',         sliceNumLogModel2, allSliceLabels, ...
                    'XLabel', 'Threshold #1s (s)', ...
                    'FigTitle', ['Threshold #1s of ', idGroup, ...
                    ' using Two-Gaussian fits'], ...
                    'YLabel', 'Cell count');
        figname = fullfile(figsFolder, ['threshold1_', idGroup, '_GaussExp']);
        plot_grouped_histogram(exp(threshold1LogModel3A  ...
                'FigName', figname, 'GroupingLabels',         sliceNumLogModel3, allSliceLabels, ...
                    'XLabel', 'Threshold #1s (s)', ...
                    'FigTitle', ['Threshold #1s of ', idGroup, ...
                    ' using Gaussian-ExpExponential fits'], ...
        ...
        plot_grouped_histogram(exp(threshold2LogModel2A  ...
                'FigName', figname, 'GroupingLabels',         sliceNumLogModel2, allSliceLabels, ...
                    'XLabel', 'Threshold #2s (s)', ...
                    'FigTitle', ['Threshold #2s of ', idGroup, ...
                    ' using Two-Gaussian fits'], ...
                    'YLabel', 'Cell count');
        figname = fullfile(figsFolder, ['threshold2_', idGroup, '_GaussExp']);
        plot_grouped_histogram(exp(threshold2LogModel3A  ...
                'FigName', figname, 'GroupingLabels',         sliceNumLogModel3, allSliceLabels, ...
                    'XLabel', 'Threshold #2s (s)', ...
                    'FigTitle', ['Threshold #2s of ', idGroup, ...
                    ' using Gaussian-ExpExponential fits'], ...
        ...
        plot_grouped_histogram(void1LogModel0AllCells, sliceNumLogModel0, ...
                    'FigName', figname, 'GroupingLabels', allSliceLabels, ...
                    'XLabel', 'Void parameters', ...
                    'FigTitle', ['Void parameters of ', idGroup, ...
                    ' using kernel distribution fits'], ...
                    'YLabel', 'Cell count', 'XLimits', [0, 1]);
        figname = fullfile(figsFolder, ['void1_', idGroup, '_GaussOnly']);
        plot_grouped_histogram(void1LogModel2AllCells, sliceNumLogModel2, ...
                    'FigName', figname, 'GroupingLabels', allSliceLabels, ...
                    'XLabel', 'Void parameter #1s', ...
                    'FigTitle', ['Void parameter #1s of ', idGroup, ...
                    ' using Two-Gaussian fits'], ...
                    'YLabel', 'Cell count', 'XLimits', [0, 1]);
        figname = fullfile(figsFolder, ['void1_', idGroup, '_GaussExp']);
        plot_grouped_histogram(void1LogModel3AllCells, sliceNumLogModel3, ...
                    'FigName', figname, 'GroupingLabels', allSliceLabels, ...
                    'XLabel', 'Void parameter #1s', ...
                    'FigTitle', ['Void parameter #1s of ', idGroup, ...
                    ' using Gaussian-ExpExponential fits'], ...
        ...
        plot_grouped_histogram(void2LogModel2AllCells, sliceNumLogModel2, ...
                    'FigName', figname, 'GroupingLabels', allSliceLabels, ...
                    'XLabel', 'Void parameter #2s', ...
                    'FigTitle', ['Void parameter #2s of ', idGroup, ...
                    ' using Two-Gaussian fits'], ...
                    'YLabel', 'Cell count', 'XLimits', [0, 1]);
        figname = fullfile(figsFolder, ['void2_', idGroup, '_GaussExp']);
        plot_grouped_histogram(void2LogModel3AllCells, sliceNumLogModel3, ...
                    'FigName', figname, 'GroupingLabels', allSliceLabels, ...
                    'XLabel', 'Void parameter #2s', ...
                    'FigTitle', ['Void parameter #2s of ', idGroup, ...
                    ' using Gaussian-ExpExponential fits'], ...
...
if plotBarFlag
    h = figure(1017);
    clf(h);
    plot_bar(muPerCellLogModel0, muPerCellLogModel0Low, ...
    ...
    h = figure(1018);
    clf(h);
    plot_bar(muPerCellLogModel2, muPerCellLogModel2Low, ...
    ...
    h = figure(1019);
    clf(h);
    plot_bar(muPerCellLogModel3, muPerCellLogModel3Low, ...
    ...
    h = figure(1020);
    clf(h);
    plot_bar([muPerCellLogModel0(1, :); muPerCellLogModel2(1, :); ...
                    ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'PTickLabel', {'Kernel', 'Gauss-Gauss', 'Gauss-ExpExp'}, ...
                    'ForceVectorAsRow', true, 'FigHandle', h);
    legend(allGroups, 'Interpreter', 'none', 'location', 'eastoutside');
    ylabel('Mean inter-spike interval (s)');
    ...
    h = figure(1021);
    clf(h);
    plot_bar(spacingPerCell, spacingPerCellLow, spacingPerCellHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'PTickLabel', {'Kernel', 'Gauss-Gauss', 'Gauss-ExpExp'}, ...
                    'ForceVectorAsRow', true, 'FigHandle', h);
    ...
    h = figure(1022);
    clf(h);
    plot_bar(threshold1PerCell, threshold1PerCellLow, threshold1PerCellHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'PTickLabel', {'Kernel', 'Gauss-Gauss', 'Gauss-ExpExp'}, ...
                    'ForceVectorAsRow', true, 'FigHandle', h);
    ...
    h = figure(1023);
    clf(h);
    plot_bar(threshold2PerCell, threshold2PerCellLow, threshold2PerCellHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'PTickLabel', {'Kernel', 'Gauss-Gauss', 'Gauss-ExpExp'}, ...
                    'ForceVectorAsRow', true, 'FigHandle', h);
    ...
    h = figure(1024);
    clf(h);
    plot_bar(void1PerCell, void1PerCellLow, void1PerCellHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'PTickLabel', {'Kernel', 'Gauss-Gauss', 'Gauss-ExpExp'}, ...
                    'ForceVectorAsRow', true, 'FigHandle', h);
    ...
    h = figure(1025);
    clf(h);
    plot_bar(void2PerCell, void2PerCellLow, void2PerCellHigh, ...
                    'BarSeparation', 0.135, ...
                    'CILineWidth', 2, ...
                    'PTickLabel', {'Kernel', 'Gauss-Gauss', 'Gauss-ExpExp'}, ...
                    'ForceVectorAsRow', true, 'FigHandle', h);
...
commands{1} = ['ZG_plot_grouped_scatter(''', figname, ''', ', ...
...
commands{2} = ['ZG_plot_grouped_scatter(''', figname, ''', ', ...
            'exp(mu1', idModel, 'AllCells), ', str1, idModel, str2, ...
            'sliceNum', idModel, ', allSliceLabels, ', ...
            '''Intra-burst mean'', ''s'', ', ...
            '''Inter-burst mean'', ''s'', ', ...
...
commands{3} = ['ZG_plot_grouped_scatter(''', figname, ''', ', ...
            'exp(mu1', idModel, 'AllCells), ', str1, idModel, str2, ...
            'sliceNum', idModel, ', allSliceLabels, ', ...
            '''Intra-burst mean'', ''s'', ', ...
            '''Inter-burst mean'', ''s'', ', ...
...
commands{4} = ['ZG_plot_grouped_scatter(''', figname, ''', ', ...
...
commands{5} = ['ZG_plot_grouped_scatter(''', figname, ''', ', ...
            'exp(threshold1', idModel, 'AllCells), exp(threshold2', idModel, 'AllCells), ', ...
            'sliceNum', idModel, ', allSliceLabels, ', ...
            '''Threshold (intersection)'', ''s'', ', ...
            '''Threshold (minimum)'', ''s'', ', ...
...
commands{6} = ['ZG_plot_grouped_scatter(''', figname, ''', ', ...
            'exp(threshold1', idModel, 'AllCells), exp(threshold2', idModel, 'AllCells), ', ...
            'sliceNum', idModel, ', allSliceLabels, ', ...
            '''Threshold (intersection)'', ''s'', ', ...
            '''Threshold (minimum)'', ''s'', ', ...
...
commands{7} = ['ZG_plot_grouped_scatter(''', figname, ''', ', ...
...
commands{8} = ['ZG_plot_grouped_scatter(''', figname, ''', ', ...
...
commands{9} = ['ZG_plot_grouped_scatter(''', figname, ''', ', ...
...
commands{10} = ['ZG_plot_grouped_scatter(''', figname, ''', ', ...
