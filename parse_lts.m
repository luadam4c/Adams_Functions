...
% 2020-07-31 Fixed second derivative units (should be kV/s^2)
...
ltsThr = -0.0023;        % 2nd derivative in kV/s^2 below which defines an LTS peak
ltsThrAlt = -0.0081823;  % 2nd derivative in kV/s^2 above which is the "gray area"
...
elseif isempty(ptemp3) ...    % Condition (2)
    ...
    peakClassLabel = ['not LTS: 2nd derivative ', ...
                        num2str(peak2ndDer), ...
                        ' kV/s^2 > LTS threshold ', ...
                        num2str(ltsThr), ' kV/s^2'];
...
if verbose
    fprintf('Selected peak 2nd derivative == %g kV/s^2\n', peak2ndDer);
end
...
if ismember(fileBase, fileBasesToOverride{idxNoiseInTrace}) ...
    ...
    if peakClass == 6 || peakClass == 7
        peakClassLabel = ['not LTS by overrule: 2nd der ', ...
                            num2str(peak2ndDer), ' kV/s^2 < ', ...
                            'LTS threshold ', num2str(ltsThr), ' kV/s^2'];
    elseif peakClass == 8 || peakClass == 9
        peakClassLabel = ['not LTS by overrule: 2nd der ', ...
                            num2str(peak2ndDer), ' kV/s^2 < ', ...
                            'alt LTS thr ', num2str(ltsThrAlt), ' kV/s^2'];
    end
