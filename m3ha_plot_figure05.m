...
if simulateIpscr || simulateTauhModes || simulateIpscVariation || ...
        ...
        plotSomaVoltage || plotM2hFig5 || plotM2hFig6 || ...
        plotVoltageVsOpdFig5 || plotVoltageVsOpdFig6 || ...
        createPlotMovieFig5 || createPlotMovieTauh || ...
        createPlotMovieGabab || simulateNoITSoma
    % Find NEURON parameter tables
    [~, exampleParamPaths] = ...
...
if plotVoltageVsOpdFig6
    ...
    for iSheet = 1:numel(gababIpscSheetBases)
        cellfun(@(x, y) plot_voltage_vs_opd(x, y, figure06Dir, figTypes, ...
                    ...
                    voltageVsOpdFig6YTickLocs, voltageVsOpdFig6ToAnnotate, ...
                    colorMapVary, false, ...
                    voltageVsOpdTimeLimits2), ...
                exampleLabelsVaryAll{iSheet}, outFoldersVaryAll{iSheet});
    end
end

%% Make movies of voltage in soma against m2hDiff in dendrite 2
...
if archiveScriptsFlag
    ...
    if simulateTauhModes || simulateIpscVariation || ...
        plotEssential || plotSomaVoltage || plotM2hFig6 || ...
        plotVoltageVsOpdFig6 || createPlotMovieTauh || createPlotMovieGabab
...
function plot_voltage_vs_opd (expStr, directory, outFolder, figTypes, ...
                                ...
                                toAnnotate, colorMap, createMovie)
