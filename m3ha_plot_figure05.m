...
voltageVsOpdFigWidth = 4.7;
voltageVsOpdFigHeight = 3;
voltageVsOpdTimeLimits = [2800, 4800];
voltageVsOpdSiMs = 1;
voltageVsOpdXLimits = [1e-8, 1e0];
voltageVsOpdYLimits = [-95, -25];
voltageVsOpdYTickLocs = [];
...
if plotVoltageVsOpd
    cellfun(@(x, y) plot_voltage_vs_opd(x, y, figure05Dir, figTypes, ...
                                voltageVsOpdFigWidth, voltageVsOpdFigHeight, ...
                                voltageVsOpdTimeLimits, voltageVsOpdSiMs, ...
                                voltageVsOpdXLimits, voltageVsOpdYLimits, ...
                                voltageVsOpdYTickLocs, colorMapPharm), ...
            exampleLabelsIpscr, outFoldersIpscr);
    for iMode = 1:numel(tauhModesAll)
    ...
    for iSheet = 1:numel(gababIpscSheetBases)
        cellfun(@(x, y) plot_voltage_vs_opd(x, y, figure06Dir, figTypes, ...
                                ...
                                voltageVsOpdTimeLimits, voltageVsOpdSiMs, ...
                                voltageVsOpdXLimits, voltageVsOpdYLimits, ...
                                voltageVsOpdYTickLocs, colorMapVary), ...
                exampleLabelsVaryAll{iSheet}, outFoldersVaryAll{iSheet});
    end
end
