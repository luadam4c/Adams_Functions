function [bl_mean, mnoise, npt, np2der, pk_prom, pk_width, pk_class, spp, ltsv, ltst, mxslv, mxslt, btime, spb, maxspi, minspi, spif, spia] = find_LTSs_many_sweeps (tvec0, vvec0, IPSC_start, ipeak_time, hrange, ltswin, plotLTSflag, outfolder, datfn, tvec2, vvec1, vvec2, vvec3)
