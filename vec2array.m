...
% Outputs:	array		- array with dimensions given by dims
% Arguments:	vector		- a vector
%				must be a vector
...
%% Map each element of the vector to an element in the array with built-in Matlab linear indexing
