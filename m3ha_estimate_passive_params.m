function [passiveParams, fitResults, fitObject, goodnessOfFit, ...
            algorithmInfo, decision, tVecFitted, vVecFitted, allResults] = ...
...
%
% Outputs:
%       Same as find_passive_params.m, but in cell array form for all cells
%
% Arguments:
%       dataMode    - 0 - all data
...
if strcmp(groupMode, 'cell')        % Group the sweeps by cellidrow
    ...
    tVecFitted = cell(nCells, 1);
    vVecFitted = cell(nCells, 1);
...
%    for iCell = 1:nCells
        ...
        if nSwps > 0
            ...
            [passiveParams{iCell}, fitResults{iCell}, fitObject{iCell}, ...
                goodnessOfFit{iCell}, algorithmInfo{iCell}, decision{iCell}, ...
                tVecFitted{iCell}, vVecFitted{iCell}, allResults{iCell}] = ...
    ...
    parfor iSet = 1:numsets
        ...
        if nSwps > 0
            ...
            [passiveParams{iSet}, fitResults{iSet}, fitObject{iSet}, ...
                goodnessOfFit{iSet}, algorithmInfo{iSet}, decision{iSet}, ...
                tVecFitted{iSet}, vVecFitted{iSet}, allResults{iSet}] = ...
                find_passive_params (tvec0, ivec0s, vvec0s, ...
                                     'PulseWindow', cpWin, ...
                                     'PulseResponseWindow', cprWin, ...
                                     'PlotFlag', plotFlag, ...
