...
simParamLabels = { ...
    ...
    'range for passive leak conductance (S/cm^2) in TC cells'; 
...
simParamNames = { ...
    ...
    'TCgababTfallSlow'; 'TCgababW'; 'TCgpasRange'; ...
    'cai0'; 'cao0'; 'cli0'; 'clo0'; ...
    'actMode'; 'actCellID'; ...
...
for iSim = 1:nSims
    ...
    simCommand = [simCommand, sprintf('randleak(%g, %g, %g, "%s", %g)\n', ...
        REgpasLB, REgpasUB, TCgpasRange, sLeakPaths{iSim}, seedNumberNeuron)];
