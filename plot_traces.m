function [h] = plot_traces(tVec, data, xlimits, xLabel, yLabel, traceLabels, ...
                            figTitle, figName, figNum)
%% Plots traces all in one place
% Usage: [h] = plot_traces(tVec, data, xlimits, xLabel, yLabel, traceLabels, ...
%                           figTitle, figName, figNum)
% Outputs: TODO
%       h           - figure handle
%
